...
const STRINGS = {
  tr: {
    ...
    musicOn: 'Sesi kapat (müzik ve hayvan sesleri)',
    musicOff: 'Sesi aç (müzik ve hayvan sesleri)',
    ...
    welcomeEnter: 'Binaya girmek için kapısına yukarı doğru yürü.',
    welcomeProHint: 'Acelen mi var?',
    welcomeProLink: 'Profesyonel Görünüm',
    welcomeClose: 'Kapat',
    walk: 'YÜRÜ',
    back: 'Geri Dön',
  ...
  en: {
    ...
    musicOn: 'Turn sound off (music and animals)',
    musicOff: 'Turn sound on (music and animals)',
    welcomeTitle: 'HELLO!',
    welcomeLine1: "I'm",
    ...
    welcomeEnter: 'Walk up into a door to go inside.',
    welcomeProHint: 'In a hurry?',
    welcomeProLink: 'Professional View',
    welcomeClose: 'Close',
    walk: 'WALK',
    back: 'Back',
